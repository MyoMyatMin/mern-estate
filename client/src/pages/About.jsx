...
export default function About() {
  return (
    <div class="px-4 py-20 max-w-6xl mx-auto">
      <h1 class="text-3xl font-bold  mb-4 text-slate-800">About M3Estate</h1>
      <p class="mb-4 text-slate-700">
        M3Estate is a leading real estate agency that specializes in helping
